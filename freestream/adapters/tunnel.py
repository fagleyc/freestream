...
class TunnelAdapter(ConfigurableAdapter):
    ...
    def snapshot(self):
        """Full PLC snapshot (RPM, fan/fault lights, stale/age) for the
        Tunnel Environment widgets. See tunnel_plc.registers.TunnelSnapshot."""
