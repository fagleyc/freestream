"""Dark theme for the LSWT fan-drive app.
...
WARNING = "#ff9800"
ERROR = "#f44336"
ERROR_LIGHT = "#ff6b5e"     # danger hover
ERROR_DARK = "#a31912"      # danger pressed / bezel
...
def get_stylesheet() -> str:
    ...
    /* Emphatic per-axis STOP: a filled danger "stop-sign" — thick bezel,
       larger/taller than plain buttons, obvious hover/pressed states. */
    QPushButton#stopaxis {{ background-color: {ERROR};
        border: 3px solid {ERROR_DARK}; border-radius: 9px;
        color: white; font-weight: 800; font-size: 13pt;
        letter-spacing: 2px; min-height: 40px; padding: 8px 14px; }}
    QPushButton#stopaxis:hover {{ background-color: {ERROR_LIGHT};
        border-color: white; }}
    QPushButton#stopaxis:pressed {{ background-color: {ERROR_DARK};
        border-color: {ERROR_DARK}; }}
    QPushButton#stopaxis:disabled {{ background-color: {BG_LIGHTER};
        color: {TEXT_DISABLED}; border-color: {BORDER}; }}
