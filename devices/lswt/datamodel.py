"""Data structures for the LSWT fan-drive interface.

Same ScanRingBuffer access pattern as the other AeroVIS devices so the
shell can treat all device streams alike (self-contained copy — device
packages stay standalone, no cross-device imports).
"""
