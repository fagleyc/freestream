"""Dark theme for the South LSWT traverse app.
...
# ── data-viz series palette (validated categorical set, dark surface) ──
# Channels get colors by enabled order; a color follows its channel in every
# panel.  All ≥3:1 contrast on BG_LIGHT; order is the CVD-safe reference order.
PALETTE = [
    "#3987e5",   # blue    (slot 1 — Pdiff in the standard setup)
    "#199e70",   # aqua    (slot 2 — Ptot)
    "#c98500",   # yellow  (slot 3 — Temp)
    "#008300",   # green
    "#9085e9",   # violet
    "#e66767",   # red
    "#d55181",   # magenta
