"""Settings dialog — deeper StrainbookConfig options (File → Settings…)."""
...
class SettingsDialog(QDialog):
    ...
    def _build(self, cfg: StrainbookConfig):
        ...
        self.device_ip.setToolTip("Informational — the DaqX config owns "
                                  "the alias→IP mapping")
