"""Help/About coverage for strainbook_616: about metadata, Help menu, docs."""
...
from strainbook_616 import about

DOCS = (Path(__file__).resolve().parents[1] / "strainbook_616" / "docs" /
        "index.html")
...
def test_package_version_matches_about():
    import strainbook_616
    assert strainbook_616.__version__ == about.__version__
...
def test_help_menu_and_about_dialog():
    ...
    win = StrainbookMainWindow(StrainbookConfig(force_sim=True))
    try:
