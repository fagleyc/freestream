"""Help/About coverage for daqbook_2000: about metadata, Help menu, docs."""
...
from daqbook_2000 import about

DOCS = (Path(__file__).resolve().parents[1] / "daqbook_2000" / "docs" /
        "index.html")
...
def test_package_version_matches_about():
    import daqbook_2000
    assert daqbook_2000.__version__ == about.__version__
...
def test_help_menu_and_about_dialog():
    ...
    from daqbook_2000.app.main_window import DaqbookMainWindow, _about_dialog
    from daqbook_2000.config import DaqbookConfig

    app = QApplication.instance() or QApplication([sys.argv[0]])
    win = DaqbookMainWindow(DaqbookConfig(force_sim=True))
    try:
