"""Dark theme for the ATE balance app.
...
# ── data-viz series colors (validated categorical set, dark surface) ──
# One fixed color per load channel, used identically in the live bar graph
